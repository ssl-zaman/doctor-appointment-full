                    ...
                    <tbody>
                        {services.map((item, index) => (
                            <tr key={item.id} className="border-b border-gray-300">
                                ...
                                <td>
                                    <Link href={route('services.statusToggle', item.id)} className={`p-2 ${item.status === 'active' ? 'border-green-500 text-green-500' : 'border-red-500 text-red-500'}  p-2 rounded-md border `}>
                                        {item.status}
                                    </Link>
                                </td>
